...
class AppFonts {
  static TextStyle appfont16 = GoogleFonts.lato(fontSize: 16);
  static TextStyle appfont20 = GoogleFonts.lato(fontSize: 20);
  static TextStyle appfont24 = GoogleFonts.lato(fontSize: 24);
  static TextStyle textfont18 = GoogleFonts.cormorant(fontSize: 18);
  static TextStyle textfont22 = GoogleFonts.cormorant(fontSize: 20);
